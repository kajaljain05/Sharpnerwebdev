...
document.addEventListener("DOMContentLoaded", () => {
  axios
    .get("https://crudcrud.com/api/d5f8568518cc487b80a457e8b07275a8/todoData")
    .then((res) => {
...
form.addEventListener("submit", (e) => {
  ...
  axios
    .post(
      "https://crudcrud.com/api/d5f8568518cc487b80a457e8b07275a8/todoData",
      { todoData }
    )
    .then((result) => {
      console.log(result);
...
function createTodo(todo, todoId) {
  ...
  completeBtn.addEventListener("click", () => {
    ...
    axios
      .put(
        `https://crudcrud.com/api/d5f8568518cc487b80a457e8b07275a8/todoData/${todoId}`,
        {
          todoData: {
            name: todo.name,
