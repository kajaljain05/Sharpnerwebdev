...
// Helper function to filter eligible students
function getEligibleStudents(students, minMarks, minPlacementAge) {
  return students.filter(student => {
    const checkEligibility = student.setPlacementAge(minMarks);
    return checkEligibility(minPlacementAge);
  });
}
